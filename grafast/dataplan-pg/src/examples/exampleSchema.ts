...
export function makeExampleSchema(
  ...
  const User: GraphQLObjectType = newObjectTypeBuilder<UserStep>(
    ...
    fields: () => ({
      ...
      // Reproduces a connection built from a list parent, as generated by the
      // `pgquery-connection-list-parent` v5 codemod fixture. Use with:
      //
      // { randomUserArray { visibleMessages { edges { node { id } } } } }
      visibleMessages: {
