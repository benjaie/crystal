...
materializes shared iterables into arrays instead of distributing one iterator
among independent consumers. A single consumer can still stream its results.
