...
materializes shared one-shot iterables into arrays instead of distributing one
iterator among independent consumers. Repeatable iterables marked with
`$$repeatable` support independent traversals without materialization.
